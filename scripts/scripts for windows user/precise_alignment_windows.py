...
#pre-process the loop structure file to only include the tested fragment
...
#length is the length of tested loop fragment, for example, for an 8-mer loop, the length is 8 
                ...
                for k in range(len(dir_3)):
                    try:
                        ...
                        for s in range(len(loop_list)):
                            ...
                            rmsd = cmd.align('mobile & i. 1-' + str(length) + ' &! h.', 'target & i. 1-'+ str(length) + ' &! h.', cycles = 0)
                            complex_pair = []
...
def copy_hits(loop_name):
    ...
    for i in range(len(csv_name)):
        ...
        for l in range(len(x)):
            ...
            cmd = 'copy /Y "' + 'conformers_for_matching\\' + folder_name + '\\' + folder_2 + '\\' + file_name + '" "' + target + '"'
            os.system(cmd)
            print(l,cmd)
